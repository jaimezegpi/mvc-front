...
/*Conexion Database.*/
if ( defined('DB_CON_FILE') && DB_STATUS) {
...
if ( file_exists(SETUP_THEME_PATH."index.php") )	{ require( SETUP_THEME_PATH."index.php" ); }else{ exit( $mvc_lang_error['file_not_exists']." view/index.php. Not Exist." ); }
